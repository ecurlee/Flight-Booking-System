...
FlightNode *FlightNodeIterator::find(FlightNode *head, char flight_num[])
{
	FlightNode *current;
	current = head;
...
void FlightNodeIterator::add(FlightNode **head, FlightNode *newNode)
{
...
//false if it was not
bool FlightNodeIterator::remove_flight(FlightNode **head, char flightnum[])
{
...
void FlightNodeIterator::clear_list(FlightNode *node)
{
	if(node)
	{
